...
export default function Hero() {
  return (
    <section id="home" className="relative flex items-center justify-center min-h-screen px-4 sm:px-6 pt-20">
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        {/* Left — Text */}
        <div className="space-y-6 sm:space-y-8 neo-card bg-black/40 backdrop-blur-sm p-6 sm:p-8 lg:bg-transparent lg:backdrop-blur-none lg:border-none lg:shadow-none lg:p-0">
          <div className="inline-block neo-border bg-[#DDFF00] text-black px-4 py-1 text-sm font-black uppercase tracking-widest">
            Hello World
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tight">
            I&apos;m{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a
              href="#projects"
              className="neo-btn bg-[#DDFF00] text-black px-8 py-3 font-black uppercase text-sm tracking-widest text-center"
            >
              My Work
            </a>
            <a
              href="#contact"
              className="neo-btn bg-transparent text-white px-8 py-3 font-black uppercase text-sm tracking-widest text-center"
            >
              Contact
            </a>
          </div>
        ...
        <div className="flex justify-center">
          <div className="neo-card bg-black/60 p-5 sm:p-6 md:p-8 w-full max-w-md space-y-4">
            ...
            <pre className="text-[11px] sm:text-xs md:text-sm font-mono leading-relaxed overflow-x-auto">
