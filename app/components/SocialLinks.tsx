    ...
    <>
      ...
      >
        {LINKS.map(({ label, href, color, icon }) => (
          <motion.a
            ...
            layout
            initial={{ opacity: 0, x: 40, width: 78 }}
            animate={{ opacity: 1, x: 0, width: 78 }}
            whileHover={{
              width: 230,
              x: -6,
            }}
          ...
          >
            <div
              className="flex h-full w-[78px] shrink-0 items-center justify-center"
              style={{ color }}
            >
              {icon}
            </div>
      ...
      >
        {LINKS.map(({ label, href, color, icon }) => (
          ...
          >
            {icon}
            <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider opacity-80">
              {label}
            </span>
          </a>
        ))}
